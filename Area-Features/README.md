...
|---|--------|----------|------|--------|--------|
|01| <p align="center">NDVI</p>| <p align="center"> **Normalized Differential Vegetation Index** </p> | Red, NIR| NDVI = $\frac{NIR - RED}{NIR + RED}$| <img width="101" height="101" alt="Image" src="https://github.com/user-attachments/assets/64f5a061-f6d0-447d-932f-68aca26e5063" />|
